...
{
<start>
<salutation> I want to <intent> <when> because <reason>. I'm sure <who> will be <reaction> to hear of my death. Please dispose of my corpse by <disposal> and give <what> to <recipient> . <closing>	;
}
